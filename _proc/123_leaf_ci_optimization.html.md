...
[source](https://github.com/ecamo19/plant_hydraulics/blob/main/plant_hydraulics/leaf_ci_optimization.py#L13){target="_blank" style="float:right; font-size:smaller"}
