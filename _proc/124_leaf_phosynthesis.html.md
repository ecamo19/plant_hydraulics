...
[source](https://github.com/ecamo19/plant_hydraulics/blob/main/plant_hydraulics/leaf_photosynthesis.py#L15){target="_blank" style="float:right; font-size:smaller"}
