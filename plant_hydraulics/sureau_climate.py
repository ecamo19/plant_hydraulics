"""Docs: https://ecamo19.github.io/plant_hydraulics/sureau_climate.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/202_sureau_climate.ipynb.

# %% auto #0
__all__ = ['new_climate_day', 'compute_Rn_and_ETP', 'new_climate_hourly', 'interpolate_climate_hourly', 'get_hourly_snapshot']

# %% ../nbs/202_sureau_climate.ipynb #5d006c0a
import pyet
import numpy as np
import pandas as pd
...
# %% ../nbs/202_sureau_climate.ipynb #6ffe577f
...
# %% ../nbs/202_sureau_climate.ipynb #00444663
...
# %% ../nbs/202_sureau_climate.ipynb #73776bfe
...
# %% ../nbs/202_sureau_climate.ipynb #e290e37d
...
# %% ../nbs/202_sureau_climate.ipynb #c228c721
